...
import robertorodrigues.curso.uber.com.activity.PassageiroActivity;
import robertorodrigues.curso.uber.com.activity.RequisicoesActivity;
...
public class UsuarioFirebase {
    ...
    public static void atualizarDadosLocalizacao(double lat, double lon){
        ...
        //Configura localizao do usuario
        geoFire.setLocation(
                usuarioLogado.getId(),
