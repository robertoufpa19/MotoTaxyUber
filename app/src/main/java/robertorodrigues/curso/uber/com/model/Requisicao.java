...
public class Requisicao {
    ...
    public void salvar(){
        ...
        DatabaseReference resquisicoes = firebaseRef.child("requisicoes");

          String idRequisicoes = resquisicoes.push().getKey();
          setId(idRequisicoes);

          resquisicoes.child(getId()).setValue(this);
    ...
    public  void atualizar(){
        ...
        DatabaseReference resquisicoes = firebaseRef.child("requisicoes");
         ...
         DatabaseReference requisicao = resquisicoes.child(getId());
    ...
    public  void atualizarLocalizacaoMotorista(){
        DatabaseReference firebaseRef = ConfiguracaoFirebase.getFirebaseDatabase();
        DatabaseReference resquisicoes = firebaseRef
                .child("requisicoes");

        DatabaseReference requisicao = resquisicoes
                .child(getId())
                .child("motorista"); // acessa o no motorista
